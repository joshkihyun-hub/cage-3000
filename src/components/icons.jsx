...
//   - rounded caps/joins, thin 1.3 stroke
...
export const IconLogIn = (props) => (
  <svg {...base} {...props}>
    ...
    {/* arrow head — drawn as two curved strokes */}
...
export const IconMenu = (props) => (
  <svg {...base} strokeWidth={1.3} {...props}>
    <path d="M4 7.2 C 8 7.0 16 7.0 20 7.3" />
    <path d="M4 12.1 C 8 12.0 16 12.0 20 12.2" />
    <path d="M4 17.0 C 8 16.9 16 16.9 20 17.1" />
  </svg>
);
